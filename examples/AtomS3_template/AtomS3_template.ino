...
// The AtomS3_Mqtt.hpp library provides setup() and loop() automatically.
// When generating new projects using this library:
// 1. Include the library: #include "AtomS3_Mqtt.hpp"
...
// Over-The-Air (OTA) ESP32 Arduino sketch update support.
