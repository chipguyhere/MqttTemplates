...
// Compiling:
// "M5Core"(M5Stack) (based on ESP32 core 2.x.x)
// "M5Core"(esp32) is based on ESP32 core 3.x.x and may crash.
...
// 6. Add UI or display material to second thread on setup1() and loop1().
//    This example won't show anything on the display, it will remain blank.
...
// Demo on LCD screen requires TFT_eSPI library to be installed, and
// the provided tft_setup.h copied into TFT_eSPI directory.
...
const char* wifi_username = ""; // Username (applies only to WPA2 Enterprise)
const char* wifi_password = "MY_WIFI_PASSWORD"; // Password for authentication
