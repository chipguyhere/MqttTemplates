/* The font vlw file can be converted to a byte array using:
   ...
   See example below. Include the tab in the main sketch, e.g.:
        ...
        This file originally came from TFT_eSPI examples.
        A newline in this font will move cursorY by 16.
        Fifteen lines will fit on a 240-line display.
        Thirty-five digits can fit on a 320-width display (9px * 35 = 315px)
